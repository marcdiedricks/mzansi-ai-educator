...
import { getUserProgress, isLevel2TestPreviewEnabled } from '../lib/progress';
...
export function Progress() {
  ...
  return (
    <div className="p-6 space-y-6 pb-24">
      ...
      {testPreview && !level1Complete && <div className="bg-amber-50 border-2 border-amber-300 rounded-xl p-3 flex gap-2 text-xs text-amber-900"><Eye className="w-4 h-4 shrink-0" /><span><strong>TEST PREVIEW ACTIVE.</strong> Level 2 test activity is visible, but Level 1 completion and certificates are unchanged.</span></div>}
