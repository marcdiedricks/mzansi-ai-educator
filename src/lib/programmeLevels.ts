...
export const LEVEL_FOUR_MODULES: ProgrammeModuleShell[] = [
  ...
  { id: 'MZAIE-P4-M05', code: '4.5', title: 'Public Service & Civic Innovation', description: 'Explore responsible AI approaches to public information, civic access and community-facing services while protecting rights and fairness.', lessonId: 'MZAIE-P4-M05-L01' },
  { id: 'MZAIE-P4-M06', code: '4.6', title: 'Measuring Impact & Evidence', description: 'Define useful outcomes, collect appropriate evidence and judge whether an AI-supported solution is actually helping people.', lessonId: 'MZAIE-P4-M06-L01' },
  { id: 'MZAIE-P4-M07', code: '4.7', title: 'Leadership, Ethics & Governance', description: 'Set accountability, oversight, escalation and governance rules for responsible AI use in real organisations and communities.', lessonId: 'MZAIE-P4-M07-L01' },
  { id: 'MZAIE-P4-M08', code: '4.8', title: 'Capstone: Build & Present a South African AI Solution', description: 'Combine the programme into a tested, evidence-backed solution proposal for a genuine South African need and present it responsibly.', lessonId: 'MZAIE-P4-M08-L01' },
];
